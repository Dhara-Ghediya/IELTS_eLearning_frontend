...
urlpatterns = [
    ...
    # path('editSpeakerQuestion',views.editSpeakerQuestion, name="editSpeakingQuestion"),
    path('editWritingQuestion',views.editWritingQuestion, name="editWritingQuestion"),
    path('editListeningQuestion',views.editListeningQuestion, name="editListeningQuestion"),
